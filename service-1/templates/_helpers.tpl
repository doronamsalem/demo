...
helm.sh/chart: {{ include "service-1.chart" . }}
{{ include "service-1.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- if .Values.serviceAccount.create -}}
    {{ default (include "service-1.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
